...
<table class="tabla">
	<tr>
		...
		<h3>Info Programa Agregado</h3>
			...
			<fieldset class="filaAgregada"><label class="impar" onMouseOver="this.className='verde'" onMouseOut="this.className='impar'">Director</label><?php echo $director ?></fieldset>
			<fieldset class="filaAgregada"><label class="impar" onMouseOver="this.className='verde'" onMouseOut="this.className='impar'">Facultad</label><?php echo $nom_facultad ?></fieldset>
			</div>
		</td>
	</tr>
</table>
