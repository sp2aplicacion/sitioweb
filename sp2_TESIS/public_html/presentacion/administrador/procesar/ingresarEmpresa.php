...
<table class="tabla">
	<tr>
		...
		<h3>Info Entidad Agregada</h3>
			...
			<fieldset class="filaAgregada"><label class="impar" onMouseOver="this.className='verde'" onMouseOut="this.className='impar'">Supervisor Entidad</label><?php echo $supervisor ?></fieldset>
