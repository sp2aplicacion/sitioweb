...
<table class="tabla">
	<tr>
		...
		<div align="center">
			<fieldset><label class="impar" onMouseOver="this.className='verde'" onMouseOut="this.className='impar'">Area</label><select name="q" id="q" onchange="return buscar(31,'&periodo='+document.forms[0].periodo.value+'&estado='+document.forms[0].estado.value)">
			...
			<select name="periodo" id="periodo" onchange="return buscar(31,'&periodo='+document.forms[0].periodo.value+'&estado='+document.forms[0].estado.value)">
			<?php for($i=date("Y")+1; $i>=2009; $i--) echo "<option value='".$i."-2'>".$i."-2</option><option value='".$i."-1'>".$i."-1</option>"; ?>
			</select>
			</fieldset>
			<fieldset><label class="impar" onMouseOver="this.className='verde'" onMouseOut="this.className='impar'">Estado</label>
			<select name="estado" id="estado" onchange="return buscar(31,'&periodo='+document.forms[0].periodo.value+'&estado='+document.forms[0].estado.value)">
			<option value="-1">Todos los estados</option> 
			<option value="0">Inscritos</option> 
