<?php
	...
	header("Content-Disposition: attachment; filename=Reporte_Entidad_".$periodo.".xls");

	echo "<table border='1' align='center'>			
		<tr>				
		<td align='center'><strong>NIT</strong></a></td>
		<td align='center'><strong>Nombre Entidad</strong></a></td>
		<td align='center'><strong>Convenios</strong></a></td>		
		</tr>";
	...
	for($i=0; $i<count($empresas); $i++)
		...
		echo "<td>";
		$reporte = new Reporte(); 
		$reporteConvenios = $reporte->conveniosPeriodoEmpresa($periodo,$empresas[$i]->getNit());
